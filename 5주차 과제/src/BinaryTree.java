...
public class BinaryTree<Key extends Comparable<Key>> {
	...
	public void preorder(BTNode<Integer> n) { if (n !=null) { System.out.print(n.getKey()+"");
																preorder(n.getLeft());
																preorder(n.getRight());
	}
	...
	public void inorder(BTNode<Integer> n) {if(n != null) {
											inorder(n.getLeft());
	...
	public void postorder(BTNode<Integer> n) {if(n != null) {
											postorder(n.getLeft());	
	...
	public int height(BTNode<Integer>n) {if(n ==null)
					return 0;
	else
